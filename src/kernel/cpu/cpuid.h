...
#define cpuid_with_ecx(eax, ecx, return_eax, return_ebx, return_ecx, return_edx)  if (cpuid_highest_function_parameter >= eax || ((eax & 0x80000000) && cpuid_highest_extended_function_parameter >= eax)) \
